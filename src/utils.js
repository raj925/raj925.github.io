...
/** Create an array of n consecutive integers and then shuffle so each appears once.
* eg randPerm(5) may output [1,5,4,2,3] or [3,5,1,2,4] etc
* For each set of trials (eg forced, choice), you only need to call this once 
* and then work your way through that array.
* @param {int} n - the number of elements in the generated array.
*/
function randPerm(n) {
    ...
    // The output is used to pull each available dot config in a random order.
